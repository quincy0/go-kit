...
import (
	...
	apinew "go-kit/tools/goctl/api/new"
	"go-kit/tools/goctl/docker"
	"go-kit/tools/goctl/kube"
	mongogen "go-kit/tools/goctl/model/mongo/generate"
	modelgen "go-kit/tools/goctl/model/sql/gen"
	rpcgen "go-kit/tools/goctl/rpc/generator"
