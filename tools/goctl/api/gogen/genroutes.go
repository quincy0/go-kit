...
func Register{{.fileName}}Handlers(server *rest.Server, serverCtx *svc.ServiceContext) {
	{{.routesAdditions}}
}
`
...
rest.WithPrefix("%s"),`, g.prefix)
	...
	routeFilename = fmt.Sprintf("%s%s_gen", apiFileName, routeFilename) + ".go"
